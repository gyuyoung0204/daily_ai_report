# Daily AI/IT News Digest Generator v2.0
# PowerShell 5.0+ compatible

param(
    [string]$OutputPath = "..\daily_ai_digest.html",
    [string]$LogPath = "..\logs\digest_log.txt",
    [string]$CachePath = "..\data\news_cache.json",
    [string]$TemplatePath = "..\templates\digest_template.html"
)
...
<div class="news-item priority">
    ...
    <p>Anthropic이 65 billion 규모의 Series H 펀딩을 완료하며 세계에서 가장 가치있는 AI 스타트업이 되었습니다. 연간 수익이 47 billion을 넘어섰습니다.</p>
...
<div class="news-item priority">
    <span class="priority-badge">⭐ 최우선</span>
    <h3>Claude Opus 4.8 출시: SWE-bench 88.6%, 병렬 에이전트 지원</h3>
    <div class="news-meta">📅 2026-06-10 | 📌 LLM Stats</div>
    <p>새로운 Claude Opus 4.8이 병렬 서브에이전트 워크플로우를 지원하며 Fast Mode로 2.5배 속도 향상을 제공합니다.</p>
...
<div class="news-item">
    ...
    <p>Google이 Gemma 4를 공개했습니다. 이 모델 시리즈는 고급 추론과 에이전틱 워크플로우를 위해 특별히 설계되었습니다.</p>
...
<div class="insights-section">
    ...
    <div class="insight-item">
        ...
        <div class="insight-content">
            • Claude Opus 4.8의 병렬 에이전트 API → 지금 바로 코드 검토 필요<br>
            • 멀티태스킹 에이전트 구현 가능 → 기존 순차 코드와 호환성 확인<br>
    ...
    <div class="insight-item">
        ...
        <div class="insight-content">
            • 병렬 에이전트 구현 방법 학습<br>
            • 기존 OpenAI 의존성 줄일 수 있는지 검토<br>
            • 프라이버시 중요 프로젝트에 Gemma 4 적용 검토
        </div>
    </div>
    <div class="insight-item">
        <span class="insight-label">🟢 모니터링:</span>
        <div class="insight-content">
            • Anthropic IPO 일정 → 다음 몇 개월 AI 스타트업 벨류에이션 기준점 제시<br>
            • 엔터프라이즈 에이전트 출현 증가 → 2026 후반부터 자동화 업계 영향
        </div>
    </div>
</div>
"@
